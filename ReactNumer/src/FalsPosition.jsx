...
const FalsePosition = () => {
    ...
    useEffect(()=>{
        axios.get("http://localhost:5000/falsePos").then(res=>{
            //console.log(res);
            setXL(res.data[0].XL)
            console.log(res.data[0].XR);
            setXR(res.data[0].XR)
        })
    },[])
            ...
            <Form >
                <Form.Group className="mb-3">
                    <Form.Label>Input f(x)</Form.Label>
                        ...
                        <input type="number" id="XL" onChange={inputXL} value={XL} style={{width:"20%", margin:"0 auto"}} className="form-control"></input>
                        <Form.Label>Input XR</Form.Label>
                        <input type="number" id="XR" onChange={inputXR} value={XR} style={{width:"20%", margin:"0 auto"}} className="form-control"></input>
                    </Form.Group>
